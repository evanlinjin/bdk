...
pub struct SpkIterator<D> {
    ...
    descriptor: D,
    secp: miniscript::bitcoin::secp256k1::Secp256k1<miniscript::bitcoin::secp256k1::VerifyOnly>,
}
...
mod test {
    use crate::{
        ...
        miniscript::{bitcoin::secp256k1::Secp256k1, Descriptor, DescriptorPublicKey},
    ...
    fn test_spkiterator_wildcard() {
        ...
        let external_spk_0 = external_desc
            .at_derivation_index(0)
            .unwrap()
            .script_pubkey();
        let external_spk_16 = external_desc
            .at_derivation_index(16)
            .unwrap()
            .script_pubkey();
        let external_spk_20 = external_desc
            .at_derivation_index(20)
            .unwrap()
            .script_pubkey();
        let external_spk_21 = external_desc
    ...
    fn test_spkiterator_non_wildcard() {
        let secp = miniscript::bitcoin::secp256k1::Secp256k1::signing_only();
